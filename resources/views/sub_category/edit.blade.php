        ...
        <div class="box span12">
            ...
            <div class="box-content">
                 @if (session()->has('success'))
                    ...
                    @endif
                <form class="form-horizontal" action="{{ route('sub_categories.update',$subCategory->id) }}" method="post" >
                    @csrf
                    @method('PUT')
                    <fieldset>
                       ...
                       <div class="control-group">
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="discription" rows="3" required>{{ $subCategory->discription}}</textarea>
                            </div>
