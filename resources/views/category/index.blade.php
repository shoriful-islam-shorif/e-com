						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">{!!$category->discription!!}</td>
								<td class="center">
									<img src="{{asset('/category/'.$category->image) }}" style="width: 150px; height:80px;">
								</td>
								<td class="center">
								...
								<td class="row">
									...
									<div class="span2">
										@if($category->status==1)
									<a class="btn btn-success" href="{{ route('cat_status',$category->id) }}">
										<i class="halflings-icon white thumbs-down"></i>  
									</a>
									@else
									<a class="btn btn-danger" href="{{ route('cat_status',$category->id) }}">
