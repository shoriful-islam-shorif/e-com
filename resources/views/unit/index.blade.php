						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">{!!$unit->discription!!}</td>
								...
								<td class="row">
									...
									<div class="span2">
										@if($unit->status==1)
									<a class="btn btn-success" href="{{ route('unit_status',$unit->id) }}">
										<i class="halflings-icon white thumbs-down"></i>  
									</a>
									@else
									<a class="btn btn-danger" href="{{ route('unit_status',$unit->id) }}">
										<i class="halflings-icon white thumbs-up"></i>  
									</a>
									@endif
									</div>
									<div class="span2">
									<a class="btn btn-info" href="{{ route('units.edit',$unit->id) }}">
